...
==== Site Navigation
Antora automatically generates navigation menus based on the structure of your documentation. It creates a table of contents, breadcrumbs, and other navigation elements to help users navigate your site efficiently.
